 ...
 * @method $this setText(string $text) Required. Text of the message to be sent, 1-4096 characters after entities parsing
 ...
 * @method $this setDisableWebPagePreview(bool $disableWebPagePreview) Optional. Disables link previews for links in this message
