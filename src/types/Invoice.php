 ...
 *
 * @method $this setTitle(string $title) Product name
 * @method $this setDescription(string $description) Product description
 * @method $this setStartParameter(string $startParameter) Unique bot deep-linking parameter that can be used to generate this invoice
