 ...
 * @method $this setVideoFileId(string $videoFileId) A valid file identifier for the video file
 ...
 * @method $this setInputMessageContent(InputMessageContent $inputMessageContent) Optional. Content of the message to be sent instead of the video
 *
